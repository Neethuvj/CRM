 ...
 <article class="rs-content-wrapper ">
    <div class="rs-content">
     ...
     echo $this->session->flashdata('success_message');
      ...
      echo form_open('user/initiate_user/'.$temp_token);
      ?>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                      <div class="<?php if(form_error('onboard-date')) { echo $error_class; } else{ echo $error_less_class;} ?> form-group has-feedback datepicker-block">
                        ...
                        <input name="onboard-date" id="onboard-date" value="<?php echo $on_board_date; ?>" type="text" class="form-control rs-datepicker" date-format="yyyy-mm-dd" placeholder="YYYY-MM-DD">
                       </div>
