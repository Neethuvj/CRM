 ...
 <div class="container products-detail admin-panel-signup activate_user">
    ...
    <div class="rs-content">
      <div class="rs-inner"> 
        ...
        <div class="container-fluid"> 
           <h3 style="color:#3f5e84;">Activate</h3>
          <!-- Begin Panel -->
     ...
     echo $this->session->flashdata('success_message');
      ...
      echo form_open('user/activate_user/'.$temp_token);
      ?>
                <div class="row">
                  <div class="col-md-12">
...
$selected_plan_id = $plan_obj->id;
 ...
 <div class="radio radio-custom">
                        <label>
                          ...
                          <?php echo form_radio('plan_id_selected', $plan_obj->id, $checked, array('
                          id' => 'selected_plan_id_'. $plan_obj->id,'disabled'=>'disabled')) ?>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                      <div class="<?php if(form_error('onboard-date')) { echo $error_class; } else{ echo $error_less_class;} ?> form-group has-feedback datepicker-block">
                        ...
                        <input name="onboard-date"  value="<?php echo $on_board_date; ?>" type="text" class="form-control rs-datepicker" date-format="mm/dd/yyyy" placeholder="MM/DD/YYYY">
                       </div>
...
<div class="col-md-12">
   ...
   <?php echo form_input(array('type' => 'hidden', 'name' => 'user_id','value' => $user_id, 'class' => 'form-control')); ?>

      <?php echo form_input(array('type' => 'hidden', 'name' => 'old_plan_id','value' => $old_plan_id, 'class' => 'form-control old_plan_id')); ?>
