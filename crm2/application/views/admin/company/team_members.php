...
<ul class="nav nav-tabs margin-bottom-10">
 <li ><a href="/admin/customer/user_summary/<?php echo $this->uri->segment(4); ?>/all">Summary</a></li>
  <li ><a href="/admin/customer/user_summary//<?php echo $this->uri->segment(4); ?>/in_progress">In Progress</a></li>
  <li><a href="/admin/customer/user_summary//<?php echo $this->uri->segment(4); ?>/completed">Completed</a></li>
  <?php if($company == 1 || $plan_id == 3) : ?>
    <li class="active"><a href="/admin/company/team_members/<?php echo $this->uri->segment(4); ?>/active">Team  Members</a></li>
  <?php endif; ?>
</ul>
...
<?php endif; ?>
 ...
 <form class="form-horizontal margin-bottom-10" action="/admin/company/team_members/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>" method="post">
   ...
   <div class="form-group has-feedback datepicker-block row">
  ...
  <a href="/admin/company/team_members/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>" class="btn btn-danger">Reset</a>
  </div>
  </div>
