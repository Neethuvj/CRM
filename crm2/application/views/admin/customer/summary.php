...
<ul class="nav nav-tabs margin-bottom-10">
 <li class="<?php echo $task_status_id == 'all'? 'active' : 'no-active'; ?>"><a href="/admin/customer/user_summary/<?php echo $customer_id; ?>/all">Summary</a></li>
  <li class="<?php echo $task_status_id == 'in_progress'? 'active' : 'no-active'; ?>"><a href="/admin/customer/user_summary/<?php echo $customer_id; ?>/in_progress">In Progress</a></li>
  <li class="<?php echo $task_status_id == 'completed'? 'active' : 'no-active'; ?>"><a href="/admin/customer/user_summary/<?php echo $customer_id; ?>/completed">Completed</a></li>
   <?php if($company == 1 || $plan_id == 3) : ?>
    <li><a href="/admin/company/team_members/<?php echo $customer_id; ?>/active">Team  Members</a></li>
     <?php endif; ?>
...
<form class="form-horizontal margin-bottom-10 user-summary-filter-form" action="/admin/customer/user_summary/<?php echo $customer_id; ?>/<?php echo $task_status_id; ?>" method="post">
 ...
 <div class="col-sm-4">
  ...
  <a href="/admin/customer/user_summary/<?php echo $customer_id; ?>/<?php echo $task_status_id; ?>/reset" class="btn btn-danger">Reset</a>
  </div>
                  ...
                  <ul class="user-details clearfix">
                      <li><label>Name: </label><span class="margin-left5"><?php echo $user_details[0]->first_name." ".$user_details[0]->last_name; ?></span></li>
                       <li><label>Plan: </label><span class="margin-left5"><?php echo $plan_name;?></span></li>
                        <li><label>Status: </label><span class="margin-left5"><?php echo ucfirst($user_status); ?></span></li>
                        <li><label>Start Date: </label><span class="margin-left5"><?php echo date("m/d/Y", strtotime($user_details[0]->created));?></span></li>
                          <li><label>Trans Date:</label><span class="margin-left5"><?php echo date("m/d/Y", strtotime($user_details[0]->transaction_date));?></span></li>
                        ...
                        <tbody>
                          <?php
                            foreach($tasks as $row)
                            {
                              ...
                              echo '<tr>';
                              echo '<td>'.'<a href="/admin/task/edit/' . $row->id .'">'.$row->id.'</a></td>';
                             

                              echo '<td>'.$row->account_name.'</td>';
                              echo '<td>'.$row->target_name.'</td>';
                              echo '<td>'.'<a href="/admin/task/edit/' . $row->id .'">'.$row->task_name.
                              '</a></td>';
