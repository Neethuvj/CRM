...
<article class="rs-content-wrapper edit_customer" >
    <div class="rs-content" >
      ...
      echo form_open('admin/customer/user_edit/'. $id);
      ?>
                <div class="row">
                ...
                <div class="col-md-12">
                    <div class="checkbox checkbox-custom">
                      ...
                      ?>
                        <input id="company-checkbox" class="company-name-open" name="company_checkbox" type="checkbox" value="1" <?php echo $checked; ?>>
