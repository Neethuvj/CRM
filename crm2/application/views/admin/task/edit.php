          ...
          <div class="p-t-xs">
            ...
            <div class="row">
              <div class="col-md-12 task-title">
                <h1>SST - <?php echo $tid; ?></a> <?php echo $task_name; ?></h1>
              </div>
...
if($this->session->flashdata('file_error_message')){
    ...
    echo '<div class="alert alert-danger">';
     ...
     if($this->session->flashdata('success_message'))
      ...
      echo form_open_multipart('admin/task/update/'. $tid, $attributes);
      ...
      <input type="hidden" name="accountant_name" class="form-control" value="<?php echo $account_name; ?>">
       ...
       <input type="hidden" name="analyst_id" class="form-control" value="<?php echo $analyst_id; ?>">
        ...
        <input type="hidden" name="previous_status" id="previous_status" class="form-control previous_status" value="<?php echo $status; ?>">
            ...
            <!-- /.row -->
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="target_name" class="form-control" value = "<?php echo $target_name;?>" >
                </div>
              </div>
              <!-- /.col-md-6 -->
          ...
          <div class="form-group">
            <label for="inputError" class="control-label"> Select Analyst
 
          </label>
      
               <select id="customer" name="analyst" class="form-control" id="search_customer">
            <option value="" disabled selected>Select Analyst</option>
     <?php foreach($get_analysts as $get_analyst):?>

        <option value="<?php echo $get_analyst->id;?>" <?php  echo ($analyst_id == $get_analyst->user_id) ? "selected" :""; ?> ><?php echo $get_analyst->first_name;?></option>
        <?php endforeach;?>
    </select>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="email_address" class="form-control" value = "<?php echo $customer_email;?>" >
                </div>
              </div>
              <!-- /.col-md-6 -->
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group has-feedback datepicker-block">
                  ...
                  <input type="text"  name="meeting_date_time" class="form-control <?php echo $class; ?>" value="<?php echo $meeting_date_time;?>" >
            ...
            <div class="form-group">
              ...
              <textarea style="resize: none;" class="form-control" name="customer_notes" id="" rows="3"  value="<?php echo $comments_additional_info;?>"><?php echo $comments_additional_info;?></textarea>
            </div>
        </div>
        <div class="col-md-6">
...
<div class="form-group">
              ...
              if($status == 4){
                echo '<option selected value="4">Deleted</option>';
              }else{
                echo '<option value="4">Deleted</option>';
              }
                ?>
              </select>
            </div>
...
<div class="col-md-6">
        ...
        <div class="col-md-12">
          <div class="form-group Analyst-Note">
            ...
            <textarea class="form-control" name="analyst_note" id="" rows="3" value="<?php echo $analyst_note; ?>"><?php echo $analyst_note; ?></textarea>
          </div>
        </div>
        <div class="col-md-6 col-sm-12 col-xs-12">
        <span class="last-updated">Last Updated : <?php echo $updated;?></span>
          <div class="form-submit">
            <input class="btn btn-default admin-email" type="submit" value="Save">
          </div>
        </div>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open('admin/task/addlog');?>
        <input type="hidden" name="task_id" class="form-control"  value="<?php echo $tid; ?>">
        <div class="row">
              ...
              <li>  
                <div class="col-md-6 col-sm-6 col-xs-6">
                  <div class="form-group has-feedback datepicker-block">
                    ...
                    <input disabled="true"   type="text" name= "log_date[]" class="form-control rs-datepicker log-date" value="<?php echo date("m/d/Y",strtotime($value->log_date));?>" data-date-format="yyyy-mm-dd" placeholder="YYYY-MM-DD">
                    <span class="fa fa-calendar form-control-feedback" aria-hidden="true"></span> </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-6">
                  <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <a href="/admin/task/edit/<?php echo $tid; ?>" class="btn btn-default cancel-log">CANCEL</a> 
         <?php echo form_close(); ?>
      </div>
    </div>
  </div>
...
<div id="add-time-page" class="modal fade admin-confirmation-email" tabindex="-1" role="dialog" aria-labelledby="gridModalLabel" data-keyboard="false" data-backdrop="static" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
