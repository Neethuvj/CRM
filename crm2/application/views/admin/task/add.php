   <article class="rs-content-wrapper task-add-admin" >
    <div class="rs-content" >
      <div class="rs-inner"> 
        ...
        <div class="container-fluid container-fluid-custom"> 
          ...
          <!-- Begin Panel -->
          <div class="panel panel-plain panel-rounded task-add">
            <div class="p-t-xs">
      ...
      echo form_open_multipart('admin/task/insert');
      ?>
     <div class="row">
      <div class="col-md-6">
        <div class="control-group">
          <div class="form-group <?php  if(form_error('customer')) { echo $error_class; } else{ echo $error_less_class;} ?> ">
            ...
            <select name="customer" id = "customer" class="form-control" id="search_customer">
        ...
        <option value="<?php echo $get_all_customer->id;?>"><?php echo $get_all_customer->first_name." ".$get_all_customer->last_name;?></option>
        <?php endforeach;?>
      </select>
        ...
        <div class="col-md-6">
          ...
          <span class="error-msg"><?php echo form_error('meeting_date_time'); ?></span>
           ...
           Contact your Business Development Assistant to ensure delievery of reports on time.</span>
         </div>
       </div>
       </div>
          ...
          <div class="control-group">
           <!--  <label for="inputError" class="control-label">BDA Id *</label> -->
            <div class="controls">
             ...
             <div class="row">
               <div class="file-wrapper col-md-6">
               <label>Attachments</label>
                    <div class="file-field-wrapper">
                      ...
                      <span class="help-text">Allowed File size is 40 Mb and allowed extensions are pdf | xls | doc | docx | xlsx | ods | txt. <b>If you upload other extensions the system will automatically remove them </b></span>
                      </div>
                      </div>
