 ...
 <article class="rs-content-wrapper ">
    <div class="rs-content">
      <div class="rs-inner"> 
        ...
        <div class="container customer-container admin-customer-signup"> 
...
$selected_plan_id = $plan_obj->id;
 ...
 <div class="radio radio-custom">
                        <label>
                           ...
                           <?php echo form_radio('plan_id_selected', $plan_obj->id, $checked, array('class'=>'plan_id_selected', 'id' =>'plan_id_selected_'. $plan_obj->id)) ?>
                ...
                <div class="row credit-card-info">
                  <div class="col-md-12">
                  ...
                  <div class="col-md-6">
                      ...
                      <label>Expiration Date *</label>
                            <div class="row">
                                ...
                                <div class="col-md-4 col-md-offset-2 col-sm-6 pad-right0 pad-left15">
