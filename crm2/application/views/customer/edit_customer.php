...
<article class="rs-content-wrapper edit_customer" >
    <div class="rs-content" >
      ...
      echo form_open('customer/user_edit/'. $id);
      ?>
                <div class="row">
                ...
                <div class="col-md-12 text-center">
                  <ul class="user-details clearfix">
                      <li><label>Name : </label><span><?php echo $user_details[0]->first_name." ".$user_details[0]->last_name?></span></li>
                      <li><label>Email : </label><span><?php echo $user_details[0]->username; ?></span></li>

                           <li><label>Phone : </label><span><?php echo $user_details[0]->phone_number;?></span></li>
                       <li><label>Plan : </label><span><?php echo $plan_name;?></span></li>
                 
                        <li><label>Hours : </label><span><?php echo $plan_hours;?></span></li>
                ...
                <?php if($user_details[0]->company == 1): ?>
                <div class="row">
                   <div class="col-md-6">
