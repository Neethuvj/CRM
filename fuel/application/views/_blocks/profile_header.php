...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/jquery-audio.min.js"></script>
...
<body>
  <!-- Navigation -->
    <nav class="navbar navbar-inverse profile navbar-fixed-top" role="navigation">
        <div class="container">
           ...
           <div  id="profile-in"> <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
